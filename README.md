...
* [Frontend](#frontend)
  + [React - framework for building *react*ive web applications](#react---framework-for-building--react-ive-web-applications)
    - [Documentation](#documentation-8)
    - [Tutorials](#tutorials-5)
  + [Apollo Client - library to make working with GraphQL API’s easy](#apollo-client---library-to-make-working-with-graphql-api-s-easy)
...
* [Backend](#backend)
  ...
  + [TypeGraphQL - easily build GraphQL API’s using TypeScript](#typegraphql---easily-build-graphql-api-s-using-typescript)
